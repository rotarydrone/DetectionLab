...
# ensure PROVISION_USER can log in
Write-Output "Setting PROVISION_USER user file permissions"
New-Item -ItemType Directory -Force -Path "C:\Users\PROVISION_USER\.ssh"
C:\Windows\System32\icacls.exe "C:\Users\PROVISION_USER" /grant "PROVISION_USER:(OI)(CI)F"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\bin" /grant "PROVISION_USER:(OI)RX"
C:\Windows\System32\icacls.exe "C:\Program Files\OpenSSH\usr\sbin" /grant "PROVISION_USER:(OI)RX"
...
C:\Windows\System32\icacls.exe "C:\Windows\Temp" /grant "PROVISION_USER:(OI)(CI)F"
...
Set-Content C:\Users\PROVISION_USER\.ssh\environment $sshenv
