...
if exist "C:\Users\PROVISION_USER\windows.iso" (
  move /Y C:\Users\PROVISION_USER\windows.iso C:\Windows\Temp
)
...
if exist "C:\Users\PROVISION_USER\VBoxGuestAdditions.iso" (
  move /Y C:\Users\PROVISION_USER\VBoxGuestAdditions.iso C:\Windows\Temp
)
