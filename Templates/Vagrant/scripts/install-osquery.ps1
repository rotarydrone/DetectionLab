...
If (-not ($service)) {
  ...
  Copy-Item "c:\Users\PROVISION_USER\AppData\Local\Temp\osquery-configuration-master\Classic\Endpoints\Windows\*" "c:\Program Files\osquery"
  Copy-Item "c:\Users\PROVISION_USER\AppData\Local\Temp\osquery-configuration-master\Classic\Endpoints\packs" -Path "c:\Program Files\osquery"
  ...
  Add-Content "c:\windows\system32\drivers\etc\hosts" "        LOGGER_IP_ADDRESS    kolide"
