...
$wefRepoPath = 'C:\Users\PROVISION_USER\AppData\Local\Temp\wef-Master.zip'
...
If (-not (Test-Path $wefRepoPath))
{
    ...
    Expand-Archive -path "$wefRepoPath" -destinationpath 'c:\Users\PROVISION_USER\AppData\Local\Temp' -Force
}
else
{
