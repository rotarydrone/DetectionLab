...
{
    Copy-Item c:\Users\PROVISION_USER\AppData\Local\Temp\windows-event-forwarding-master\windows-event-channels\CustomEventChannels.dll "$env:windir\system32"
    Copy-Item c:\Users\PROVISION_USER\AppData\Local\Temp\windows-event-forwarding-master\windows-event-channels\CustomEventChannels.man "$env:windir\system32"
    ...
    cd c:\Users\PROVISION_USER\AppData\Local\Temp\windows-event-forwarding-master\wef-subscriptions
