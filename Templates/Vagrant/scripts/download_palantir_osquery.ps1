...
$osqueryRepoPath = 'C:\Users\PROVISION_USER\AppData\Local\Temp\osquery-Master.zip'
if (-not (Test-Path $osqueryRepoPath))
{
    ...
    Expand-Archive -path "$osqueryRepoPath" -destinationpath 'c:\Users\PROVISION_USER\AppData\Local\Temp' -Force
}
else
{
